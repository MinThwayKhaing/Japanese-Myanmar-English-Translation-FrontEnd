...
import { View, Text, StyleSheet, StatusBar, TouchableOpacity, ActivityIndicator, ScrollView, Platform, } from 'react-native';
...
const ProfileScreen = () => {
    ...
    return (<SafeAreaView style={styles.safeContainer}>
      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <View style={styles.section}>
          ...
          {!user?.subscribed && (<TouchableOpacity style={styles.upgradeButton}>
    ...
    <TouchableOpacity style={styles.upgradeButton} onPress={() => navigation.navigate('ChangePassword')}>
