    ...
    useEffect(() => {
        const init = async () => {
            ...
            try {
                ...
                setIsFavorite(favList.some((fav) => fav.id === id));
            }
            catch (err) {
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        ...
        <View style={styles.titleRow}>
          ...
          <TouchableOpacity onPress={toggleFavorite}>
            <Ionicons name={isFavorite ? 'heart' : 'heart-outline'} size={28} color={isFavorite ? 'red' : Colors.primary}/>
          </TouchableOpacity>
        </View>
        ...
        {word.myanmar && (<View style={styles.row}>
...
//# sourceMappingURL=UserWordDetail.js.map