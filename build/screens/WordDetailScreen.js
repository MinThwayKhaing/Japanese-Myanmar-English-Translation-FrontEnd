...
export default function WordDetailScreen() {
    ...
    return (<ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={[styles.favoriteButton, isFavorite && styles.favoriteActive]} onPress={() => setIsFavorite(!isFavorite)}>
...
//# sourceMappingURL=WordDetailScreen.js.map